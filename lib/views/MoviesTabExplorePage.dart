...
class MoviesTabExplorePage extends StatefulWidget {
  final String title;

  const MoviesTabExplorePage({Key? key, required this.title}) : super(key: key);

  @override
  _MoviesTabExplorePageState createState() => _MoviesTabExplorePageState();
}

class _MoviesTabExplorePageState extends State<MoviesTabExplorePage> {
  final tmdb = TMDB(
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              height: 250, // Adjust height as needed
              child: FutureBuilder<dynamic>(
                future: tmdb.v3.discover.getMovies(
                    sortBy: SortMoviesBy.revenueDesc,
